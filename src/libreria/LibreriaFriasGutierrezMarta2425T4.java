...
public class LibreriaFriasGutierrezMarta2425T4 {
  ...
  private double saldo;   // Saldo de la librerÃ­a
  ...
  /**
   * Método que obtiene el saldo de la librerÃ­a
   * @return Saldo actual
   */
  ...
  /**
   * Método que establece el saldo de la librerÃ­a
  ...
  /**
   * Constructor con cuatro parámetros para inicializar la librerí­a
   * @param nom Nombre del libro
   * @param cantidad Cantidad de ejemplares que hay disponibles (en stock)
   * @param precio Precio del libro
   * @param saldo Saldo en la cuenta de la librerÃ­a
   */
  ...
  /**
   * Método que devuelve el saldo actual de la librerí­a
   * @return Saldo de la librerÃ­a
   */
  ...
  /**
   * Método para aumentar el saldo de la librerí­a.
  ...
  public void comprarLibro(int canti) throws Exception {
    ...
    if (getCantidad() >= canti) {
      ...
      throw new Exception("No se pueden comprar mÃ¡s libros de los que hay disponibles");
    }
